...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        'elev-1': '0 1px 4px rgba(0,0,0,0.4), 0 0 0 1px rgba(74,142,196,0.10)',
        'elev-2': '0 4px 16px rgba(0,0,0,0.5), 0 0 0 1px rgba(74,142,196,0.14)',
        'elev-3': '0 12px 40px rgba(0,0,0,0.65), 0 0 0 1px rgba(74,142,196,0.18)',
        'gold':   '0 0 24px rgba(74,142,196,0.25)',
      },
      transitionDuration: {
        fast: '100ms',
        base: '150ms',
